export default function AWSCard({
  ...
  return (
    <div
      ...
      className={`relative bg-[#f3f3f7] p-6 rounded-2xl h-[27.5svh] max-h-60 lg:h-70 w-[calc(100svw-2rem)] max-w-110 border-2 border-transparent cursor-pointer font-aws flex flex-col transition-colors duration-300 dark:bg-[#20202a] ${
        !isRevealed &&
        !isAnimating &&
    ...
    >
      ...
      <div
        className={`flex flex-col h-full transition-opacity duration-300 dark:text-white ${
